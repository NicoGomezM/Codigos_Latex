...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{flalign*}
        ...
        &= 1 - (\frac{1}{9} + [\frac{(\frac{80}{50})^1}{1!}\cdot\frac{1}{9}] + [\frac{(\frac{80}{50})^2}{2!}\cdot\frac{1}{9}] + [\frac{(\frac{80}{50})^3}{2!\cdot 2^{3-2}}\cdot\frac{1}{9}] + [\frac{(\frac{80}{50})^4}{2!\cdot 2^{4-2}}\cdot\frac{1}{9}])\\
        &= 1 - [\frac{1}{9} + \frac{8}{45} + \frac{32}{225} + \frac{128}{1125} + \frac{512}{5625}] \\
        &= 1 - 0.6359 \\
        &= 0.3641
    \end{flalign*}
