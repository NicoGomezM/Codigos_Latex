...
\begin{enumerate}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \begin{equation*}
            \pi_3 = (0.325, 0.31, 0.365)
        \end{equation*}

        \begin{itemize}
            \item Primer curso: 600 * 0.325 = 195
            \item Segundo curso: 600 * 0.31 = 186
            \item Tercer curso: 600 * 0.365 = 219
        \end{itemize}
        Por lo tanto al principio del tercer año tendremos 219 alumnos en tercer curso, 186 en segundo y 195 en primer curso.
...
\begin{enumerate}[start = 3]
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        $P_{2} = (1 \rightarrow 3 \rightarrow 3 \rightarrow 2) + (1 \rightarrow 2 \rightarrow 1 \rightarrow 3) + (1 \rightarrow 2 \rightarrow 3 \rightarrow 3) + 
        \\(1 \rightarrow 3 \rightarrow 2 \rightarrow 3) + (1 \rightarrow 3 \rightarrow 2 \rightarrow 1)\\$
        $P_{2} = (0.5 \cdot 0.8 \cdot 0.2) + (0.5 \cdot 0.4 \cdot 0.5) + (0.5 \cdot 0.6 \cdot 0.8) + (0.5 \cdot 0.2 \cdot 0.6) + (0.5 \cdot 0.2 \cdot 0.4)\\$
        $P_{2} = 0.08 + 0.1 + 0.24 + 0.06 + 0.04\\$
        $P_{2} = 0.52$

        \item El proceso realice la transición $1\rightarrow2$ exactamente una vez en las tres primeras transiciones.
        \begin{align*}
